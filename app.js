...
var _user$project$Types$Model = F4(
	function (a, b, c, d) {
		return {display: a, result: b, conversion: c, last: d};
	});
var _user$project$Types$None = {ctor: 'None'};
var _user$project$Types$Oct = {ctor: 'Oct'};
var _user$project$Types$Hex = {ctor: 'Hex'};
var _user$project$Types$Bin = {ctor: 'Bin'};
var _user$project$Types$Clear = {ctor: 'Clear'};
var _user$project$Types$Conv = function (a) {
	return {ctor: 'Conv', _0: a};
};
var _user$project$Types$Value = function (a) {
	return {ctor: 'Value', _0: a};
};
var _user$project$Types$Calc = {ctor: 'Calc'};

var _user$project$View$numButton = function (num) {
	return A2(
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('conversor-row'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _user$project$View$numButton(1),
					_1: {
						ctor: '::',
						_0: _user$project$View$numButton(2),
						_1: {
							ctor: '::',
							_0: _user$project$View$numButton(3),
							_1: {
								ctor: '::',
								_0: _user$project$View$numButton(0),
								_1: {ctor: '[]'}
							}
						}
					}
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$View$numButton(4),
						_1: {
							ctor: '::',
							_0: _user$project$View$numButton(5),
							_1: {
								ctor: '::',
								_0: _user$project$View$numButton(6),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$button,
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$View$numButton(7),
							_1: {
								ctor: '::',
								_0: _user$project$View$numButton(8),
								_1: {
									ctor: '::',
									_0: _user$project$View$numButton(9),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$button,
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('conversion-button'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(
														_user$project$Types$Conv(_user$project$Types$Bin)),
													_1: {ctor: '[]'}
												}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Bin'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
								...
								_0: A2(
									_elm_lang$html$Html$button,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_user$project$Types$Conv(_user$project$Types$Hex)),
											_1: {ctor: '[]'}
										}
									},
									{
									...
									_0: A2(
										_elm_lang$html$Html$button,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
													_user$project$Types$Conv(_user$project$Types$Oct)),
												_1: {ctor: '[]'}
											}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Oct'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$button,
											{
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$Calc),
													_1: {ctor: '[]'}
												}
											},
											{
...
var _user$project$View$displays = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('display-tittle'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Resultado'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('conversor-display'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Entrada'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
var _user$project$View$mainContent = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('conversor-container'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$View$displays(model),
			_1: {
				ctor: '::',
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('conversor-tittle'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Conversor'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$Conversor$main = _elm_lang$html$Html$beginnerProgram(
	{model: _user$project$Update$initialModel, view: _user$project$View$view, update: _user$project$Update$update})();

var Elm = {};
Elm['Conversor'] = Elm['Conversor'] || {};
if (typeof _user$project$Conversor$main !== 'undefined') {
    _user$project$Conversor$main(Elm['Conversor'], 'Conversor', undefined);
}
